...
export class Saucer {
    constructor(gameWidth, gameHeight, isSmall = false) {
        this.entityType = 'saucer';
    ...
    createBullet(shipX, shipY) {
        ...
        return new Bullet(this.x + this.width / 2, this.y + this.height / 2, angle, false // Not player bullet
        );
    }
    draw(ctx) {
