...
export class Asteroid {
    ...
    split() {
        ...
        if (this.size === 'large') {
            ...
            for (let i = 0; i < 2; i++) {
                ...
                children.push(new Asteroid(this.x + this.width / 2, this.y + this.height / 2, 'medium', Math.cos(angle) * speed, Math.sin(angle) * speed));
            }
        }
            ...
            for (let i = 0; i < 2; i++) {
                ...
                children.push(new Asteroid(this.x + this.width / 2, this.y + this.height / 2, 'small', Math.cos(angle) * speed, Math.sin(angle) * speed));
            }
        }
    ...
    static createWave(count, gameWidth, gameHeight, shipX, shipY, safeRadius = 40) {
        const asteroids = [];
        for (let i = 0; i < count; i++) {
            ...
            do {
                ...
                attempts++;
            } while (Math.hypot(x - shipX, y - shipY) < safeRadius &&
                attempts < 50);
